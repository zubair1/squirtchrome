...
var readability = {
  ...
  regexps: {
    ...
    positive:              /code|pre|article|body|content|content__main|section-inner|gs-container|entry|hentry|main|page|pagination|post|text|blog|story/i,
  ...
  grabArticle: function () {
	...
	if (length < 250 || (medium > 30 && window.location.hostname.indexOf('medium.com') != -1)){
